...
def sample_edit_distance_v6(cluster: str, create_large_max: bool = False) -> int:
    """
    V6: Sample edit distance from cluster with proper correlations.

    FIX 6: 'large' cluster generates both ED=3 and ED=4 (correlation)
    FIX 11: When create_large_max=True, bias toward higher values
    """
    if cluster == 'none':
        return 0
    elif cluster == 'small':
